                        ...
                        <section>
                            ...
                            <mdb-row>
                                <mdb-col md="3" class="mb-3">
                                    ...
                                    <img class="img-fluid z-depth-1" src="../../../../../images/modal4.jpg" alt="frame position"/>
                                ...
                                <mdb-col md="3" class="mb-3">
                                    ...
                                    <img class="img-fluid z-depth-1" src="../../../../../images/modal3.jpg" alt="frame position"/>
                                    <div class="text-center">
                                        <h5 class="my-3">Position</h5>
                                ...
                                <mdb-col md="3" class="mb-3">
                                    ...
                                    <img class="img-fluid z-depth-1" src="../../../../../images/modal2.jpg" alt="frame position"/>
                                    <div class="text-center">
                                ...
                                <mdb-col md="3" class="mb-3">
                                    ...
                                    <img class="img-fluid z-depth-1" src="../../../../../images/modal1.jpg" alt="frame position"/>
                                    <div class="text-center">
                                        <h5 class="my-3">Position</h5>
...
<script>
    import { mdbRow, mdbCol, mdbCard, mdbCardBody, mdbTbl,
        mdbBtn, mdbCardHeader, mdbCardText, mdbIcon, mdbModal, mdbModalHeader,
        mdbModalTitle, mdbModalBody, mdbModalFooter } from 'mdbvue'
    export default {
        name: "GoogleMapDashboard",
        components:{
            mdbRow, mdbCol, mdbBtn, mdbCard,
            mdbCardBody, mdbCardHeader, mdbCardText,
            mdbIcon, mdbTbl, mdbBtn, mdbCardHeader,
            mdbCardText, mdbIcon,mdbModal, mdbModalHeader,
